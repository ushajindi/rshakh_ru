    ...
    return (
        <div className='membersbox'>
            <div className="membersbox__inner">
                <div className="membersbox__text">
                    <p>Online</p>
                    <p>4</p>
                </div>
                <div className="membersbox__items">
                    <UserIcon online={'online'}/>
                    <div className="membersbox__item__user">
                        <p className="membersbox__username">Ushajindi</p>
                        <p className="membersbox__user__status">work in </p>
                    </div>
                </div>
                <div className="membersbox__items">
                    <UserIcon online={'online'}/>
                ...
                <div className="membersbox__items">
                    <UserIcon online={"offline"}/>
                    <div className="membersbox__item__user">
                        <p className="membersbox__username">Ushajindi</p>
                        <p className="membersbox__user__offline">last 14 hour </p>
                    </div>
                </div> <div className="membersbox__items">
                    <UserIcon online={"offline"}/>
                    <div className="membersbox__item__user">
                        <p className="membersbox__username">Ushajindi</p>
                        <p className="membersbox__user__offline">last 14 hour </p>
                ...
                </div> <div className="membersbox__items membersbox__items__end">
                    <UserIcon online={"offline"}/>
                    <div className="membersbox__item__user">
                        <p className="membersbox__username">Ushajindi</p>
                        <p className="membersbox__user__offline">last 14 hour </p>
            ...
            <div className="membersbox__btn">
                <div className="membersbox__btn__inner">
                    <div className="membersbox__btn__item">
                    ...
                    <div className="membersbox__btn__item active">
