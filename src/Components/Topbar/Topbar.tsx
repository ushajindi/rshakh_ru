        ...
        <div className="topbar">
            ...
            <div className="topbar__btn">
                <div className="topbar__btn__inner">
                    <div onClick={()=>{rootStore.GeneralPage.setMainBox("lenta")}} className={`topbar__btn__items ${rootStore.GeneralPage.mainBox==="lenta"&&"active"}`}>
                    ...
                    <div onClick={()=>{rootStore.GeneralPage.setMainBox("chatbox")}} className={`topbar__btn__items ${rootStore.GeneralPage.mainBox==="chatbox"&&"active"}`}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={()=>{rootStore.GeneralPage.setMainBox("library")}} className={`topbar__btn__items ${rootStore.GeneralPage.mainBox==="library"&&"active"}`}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
