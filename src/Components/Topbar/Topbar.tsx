        ...
        <div className="topbar">
            ...
            <div className="topbar__btn">
                <div className="topbar__btn__inner">
                    <div onClick={()=>{props.changeBox({mainBox:"lenta"})}} className={`topbar__btn__items ${props.activebox==="lenta"&&"active"}`}>
                    ...
                    <div onClick={()=>{props.changeBox({mainBox:"chatbox"})}} className={`topbar__btn__items ${props.activebox==="chatbox"&&"active"}`}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div onClick={()=>{props.changeBox({mainBox:"library"})}} className={`topbar__btn__items ${props.activebox==="library"&&"active"}`}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
