    ...
    return(
        <div style={{width:props.width}} className='chatinput'>
            <div className="chatinput__inner">
                ...
                <div className="chatinput__items">
                    <textarea onChange={(e)=>{
                        rootStore.MessageStore.setMessageValue(e.target.value)
                    }} value={rootStore.MessageStore.messageValue} className="chatinput__items__input" role="textbox" contentEditable></textarea>
                </div>
                <div className="chatinput__items">
                    <button className="chatinput__items__file">
                    ...
                    <button disabled={!(rootStore.MessageStore.messageValue)}
                            onClick={()=>{
                                rootStore.MessageStore.sendMessage()
                            }}

                            className="chatinput__items__send">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
