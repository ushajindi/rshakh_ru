...
const Message = (props: any) => {
    ...
    return (
        <div
            ...
            className={`message ${
                rootStore.UserStore.User?._id === props.messages.user._id ? "me" : ""
            }`}
        >
            <div className="message__inner">
                <div className="message__items">
                    <div className="message__items__user">
                        <div className="message__items__user__items">
                            <UserIcon
                                width={"50px"}
                                src={props.messages?.avaimg}
                                online={"online"}
                            />
                            <p className="message__items__username">
                                {props.messages.user.username}
                            </p>
                    ...
                    <div className="message__item__media">
                        {props.messages.img &&
                            props.messages.img.map((e: any, index: number) => {
                                return (
                                    <div key={index} className="message__item__media__items">
                                        <img src={e.src} alt="Media" />
                                    </div>
                                );
                            })}
                    </div>
